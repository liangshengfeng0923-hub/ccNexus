export default {
    ...
    apikeys: {
        ...
        never: 'Never',
        lastUsed: 'Last Used',
        endpoints: 'Accessible Endpoints',
        selectEndpoints: 'Select Endpoints',
        noKeys: 'No API Keys',
        noKeysMessage: 'Create API keys to control access permissions',
        confirmDelete: 'Are you sure you want to delete key "{name}"?',
        confirmRegenerate: 'Regenerating the key will invalidate the old one. Continue?',
        ...
        authEnabled: 'Enable API Key Authentication',
        authDisabled: 'Disable API Key Authentication',
        authEnabledHelp: 'When enabled, all proxy requests must provide a valid API Key',
